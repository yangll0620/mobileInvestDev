...
public class SearchedFundListAdapter extends BaseAdapter {
    ...
    private ArrayList<Fund> fundsArraylist;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.activity_fund_listview_item, null);

            // Locate the TextViews in listview_item.xml
            vholder = new ViewHolder();
            vholder.tv_fundsymbol = (TextView) view.findViewById(R.id.fund_symbol);
            vholder.tv_fundname = (TextView) view.findViewById(R.id.fund_name);
            view.setTag(vholder);
        } else {
